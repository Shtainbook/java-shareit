...
public class ItemRequestControllerTest {
    ...
    @Test
    @SneakyThrows
    public void getUserRequestsWithIncorrectUserId() {
        //when
        mvc.perform(
                        get("/requests")
                                .header("X-Sharer-User-Id", 0)
    ...
    @Test
    @SneakyThrows
    public void getUserRequestsWithIncorrectParamFrom() {
        //when
        mvc.perform(
                        get("/requests")
                                .header("X-Sharer-User-Id", 1)
    ...
    @Test
    @SneakyThrows
    public void getUserRequestsWithIncorrectParamSize() {
        //when
        mvc.perform(
                        get("/requests")
                                .header("X-Sharer-User-Id", 1)
    ...
    @Test
    @SneakyThrows
    public void getDifferentRequestsWitchIncorrectUserId() {
        //when
        mvc.perform(
                        get("/requests/all")
                                .header("X-Sharer-User-Id", 0)
        ...
        verify(itemRequestService, times(0)).getDifferentRequests(any(PageRequest.class), anyLong());
    }

    @Test
    @SneakyThrows
    public void getDifferentRequestsWitchIncorrectParamFrom() {
        //when
        mvc.perform(
                        get("/requests/all")
                                .header("X-Sharer-User-Id", 1)
    ...
    @Test
    @SneakyThrows
    public void getDifferentRequestsWitchIncorrectParamSize() {
        //when
        mvc.perform(
                        get("/requests/all")
                                .header("X-Sharer-User-Id", 1)
    ...
    @Test
    @SneakyThrows
    public void getInfoRequestWitchIncorrectUserId() {
        //when
        mvc.perform(
                        get("/requests/1")
                                .header("X-Sharer-User-Id", 0)
        ...
        verify(itemRequestService, times(0)).getInfoRequest(anyLong(), anyLong());
    }

    @Test
    @SneakyThrows
    public void getInfoRequestWitchIncorrectItemRequestId() {
        //when
        mvc.perform(
                        get("/requests/0")
                                .header("X-Sharer-User-Id", 1)
